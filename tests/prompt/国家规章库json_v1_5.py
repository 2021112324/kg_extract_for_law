...
3. 对于每个法规条款，如果其内容提及了本法规文件以外的其他文件，则需要提取“文件依据”实体，且必须建立起法规条款到文件依据之间的关系，即“法规条款-依据-文件依据”关系。
4. 对于每个法规条款，如果其内容提及了法规条款，若法规条款是本法规文件内的，则建立起法规条款到被提及法规条款之间的关系，即“法规条款-提及-法规条款”关系；若法规条款不是本法规文件内的，则建立起法规条款到外部法规条款依据之间的关系，即“法规条款-依据-外部法规条款依据”关系。
"""
schema = {
    "nodes": str(nodes),
    "edges": str(edges)
...
examples = [
    {
        "text": "药品生产质量管理规范（2010年修订）（2011年1月17日卫生部令第79号公布 自2011年3月1日起施行）\n第一章 总则\n第一条 为规范药品生产质量管理，根据《中华人民共和国药品管理法实施条例》（后简称药品管理法实施条例），制定本规范。\n第二章　质量管理\n第二节　质量保证\n第八条 "
                "质量保证是质量管理体系的一部分。依据药品管理法实施条例第五条，企业必须建立质量保证系统，同时建立完整的文件体系，以保证系统有效运行。\n第十条 "
                "依据本规范第八条，药品生产质量管理的基本要求：\n（一）制定生产工艺，系统地回顾并证明其可持续稳定地生产出符合要求的产品；\n（三）配备所需的资源，至少包括：\n1.具有适当的资质并经培训合格的人员；\n2"
        ...
        "nodes": [
            ...
            },
            {
                ...
                "attributes": {
                    "条款编号": "第一条",
                    "条款全文": "为规范药品生产质量管理，根据《中华人民共和国药品管理法实施条例》（后简称药品管理法实施条例），制定本规范。",
                    "所属章": "第一章　总则",
                    "条款功能类型": "定义",
                    "法律层级": "部门规章"
                }
            ...
            },
            {
                ...
                "attributes": {
                    "条款编号": "第八条",
                    "条款全文": "质量保证是质量管理体系的一部分。依据药品管理法实施条例第五条，企业必须建立质量保证系统，同时建立完整的文件体系，以保证系统有效运行。",
                    "所属章": "第二章　质量管理",
                    "所属节": "第二节　质量保证",
                    "条款功能类型": "义务",
                    "法律层级": "部门规章"
