nodes = [
    ...
    {
        "entity": "诉讼事由",
        "description": "指引发本次诉讼的具体事实原因或争议起点，即\"因何事成讼\"。",
        "properties": {
            "事由内容": "对引发诉讼的事实事件的描述",
    ...
    {
        "entity": "国家机构",
        "description": "表示诉讼中涉及的行政机构、立法机构等国家单位",
        "properties": {
    ...
    {
        "entity": "具体行政行为",
        "description": "诉讼中涉及的具体执法行为或行政行为（如处罚、许可、强制）",
        "properties": {
...
edges = [
    ...
    },
    {
        ...
        "source_name": "诉讼",
        "target_name": "诉讼事由",
        "description": "表示行政判决书中的诉讼围绕诉讼事由进行诉讼裁决"
    },
    {
        "relation": "围绕",
        "source_name": "诉讼",
        "target_name": "事实事件",
        "description": "表示诉讼围绕某些事实事件进行诉讼裁决，即一场诉讼案件可能涉及多个事实事件"
    },
    {
        "relation": "引发",
        "source_name": "具体行政行为",
        "target_name": "诉讼事由",
        "description": "一般用于二审、再审，表示诉讼者不满一审判决的具体行政行为提出诉讼，即具体行政行为引发诉讼事由"
    },
    {
        "relation": "包含",
        "source_name": "诉讼事由",
        "target_name": "事实事件",
        "description": "诉讼事由中会包含争议的或待裁决的事实事件"
    },
    {
        "relation": "包含",
        "source_name": "裁判结果",
        "target_name": "具体行政行为",
        "description": "诉讼的判决结果中可包含对案件当事人的具体行政行为（如处罚）"
    },
    {
        "relation": "涉及",
        "source_name": "事实事件",
    ...
    },
    {
        ...
        "source_name": "裁判结果",
        "target_name": "事实事件",
        "description": "表示裁判结果解决的事实事件中的某争议焦点"
    },
    {
        "relation": "作出",
        "source_name": "诉讼",
        "target_name": "裁判结果",
        "description": "诉讼对诉讼案由作出裁判结果"
    },
    {
        "relation": "作出",
        "source_name": "国家机构",
        "target_name": "裁判结果",
        "description": "表示法院或执法机关作出了某一裁判结果"
    },
    {
        "relation": "依据",
        "source_name": "裁判结果",
    ...
    },
    {
        ...
        "source_name": "具体行政行为",
        "target_name": "法规条款依据",
        "description": "表示具体行政行为依据某法规条令而执行"
    },
    {
        "relation": "遭受",
        "source_name": "案例主体",
    ...
    },
    {
        ...
        "source_name": "国家机构",
        "target_name": "具体行政行为",
        "description": "国家机构依法执行具体行政行为"
    },
    {
        "relation": "作用于",
        "source_name": "具体行政行为",
        "target_name": "案例主体",
        "description": "执法行为或行政行为作用于案例主体"
    }
]
