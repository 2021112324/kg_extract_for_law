...
## 案例
### 介绍
表示合规案例库中的一个具体案例，是合规知识图谱的核心实体，用于承载事实、行为、案例分析、启示等。
### 属性
- 案例名称：案例的正式标题，不包含编号、标号和非实体可拥有的符号，即不包含（案例一、序号5等）
- 案例编号：案例在案例库中的序号
- 合规领域：案例所属的合规领域章节，如“反腐败反商业贿赂”
...
## 法律规章
### 介绍
表示对行为进行案例分析时适用的法律、行政法规、司法解释或域外法律。
### 属性
- 法规名称：法律规章的正式名称，不包含具体的条款，重要部分
- 条款编号：法律规章的具体条款编号，如第十条，第十二条第八款，重要部分
- 法规简称：法律规章的正式名称对应的简称
- 法规内容摘要：法规主要内容的简要概括
