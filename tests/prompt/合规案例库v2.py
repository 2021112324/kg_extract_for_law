...
## 法规条款依据
### 介绍
表示对行为进行案例分析时依据的法律、行政法规、部门规章或司法解释中的具体条、款、项等，获取实例时应选取 完整名称+条款，如《中华人民共和国刑法》第十条
### 属性
...
## 违反
### 介绍
某一行为触犯、破坏了某项具体法规条款的规定。
### 关系三元组
- 行为-违反-法规条款依据

## 遭受
### 介绍
1. 案例主体依据其行为和法规遭受到具体的处罚结果或处理结果
2. 表示案例主体遭受了某项具体行为的侵害或损害。
### 关系三元组
- 案例主体-遭受-行为
- 案例主体-遭受-裁判结果
...
## 隶属于
### 介绍
若两个案件主体一个为自然人，一个为组织，则可以存在自然人隶属于组织的关系，如王某隶属于A公司
注意：隶属于的关系双方是两个不同的实体
### 关系三元组
- 案例主体-隶属于-案例主体
