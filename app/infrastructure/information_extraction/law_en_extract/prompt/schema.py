...
#   - unit_number          单元编号
#   - hierarchy_path       层级路径（从法条到此单元的完整路径）
...
#   - time_element         时间要素        - quantitative_standard  量化标准
...
## Provision Unit
### Description
A complete semantic unit inside the Legal Provision, such as a subsection,
paragraph, subparagraph, clause, item, note or reserved unit. A lower-level item
must keep enough parent context to remain legally meaningful.
### Properties
...
- unit_number: normalized English unit number, such as Section 1701 subsection (a)
- hierarchy_path: full parent path from the Legal Provision to this unit
- applicable_industry: industry to which the unit applies, if stated
...
- abbreviation: abbreviation if stated
- document_type: Act, Code, Regulation, CFR Part, Rule, Order, Directive, Treaty or other
- provision_number: cited provision number, if any
