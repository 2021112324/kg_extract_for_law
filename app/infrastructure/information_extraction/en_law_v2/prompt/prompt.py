...
prompt_for_article = """
# Role
You are an expert in United States Act section analysis.

# Task
Extract attributes for exactly one SECTION/SEC/Sec LegalProvision. This step is
...
# Role
You are an expert in United States Act subsection analysis.

# Task
Extract knowledge graph information from one code-split ProvisionClause only.
The parent SECTION/SEC/Sec provision and current ProvisionClause are already
...
7. Do not cross into another SECTION/SEC/Sec provision or another
   ProvisionClause.
