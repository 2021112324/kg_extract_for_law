...
# 导出 few-shot 示例对象。
from app.infrastructure.information_extraction.en_law_v1.prompt.example import (
    example_for_article,
    example_for_file_info,
    example_for_provision_clause,
)
# 导出文件级和 Article 级提示词文本。
from app.infrastructure.information_extraction.en_law_v1.prompt.prompt import (
    prompt_for_article,
