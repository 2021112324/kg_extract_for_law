...
from app.infrastructure.information_extraction.guide_extract.prompt.example import example_for_clause, \
    example_for_file_info
from app.infrastructure.information_extraction.guide_extract.prompt.prompt import prompt_for_clause, prompt_for_file_info
from app.infrastructure.information_extraction.guide_extract.prompt.schema import schema_for_clause, schema_for_file_info
...
if __name__ == "__main__":
    ...
    extractor = GuideClauseExtractor()
    result = asyncio.run(
