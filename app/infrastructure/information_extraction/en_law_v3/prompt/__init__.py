...
from app.infrastructure.information_extraction.en_law_v3.prompt.example import (
    example_for_article,
    example_for_file_info,
    example_for_provision_clause,
)
from app.infrastructure.information_extraction.en_law_v3.prompt.prompt import (
    prompt_for_article,
